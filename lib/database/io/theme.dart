...
class ThemeStruct {
  ...
  Map<String, dynamic> toMap() => {
    ...
    "data": {
      ...
      "colorScheme": {
        ...
        "background": data.colorScheme.surface.value,
        "onBackground": data.colorScheme.onSurface.value,
        "surface": data.colorScheme.surface.value,
        "onSurface": data.colorScheme.onSurface.value,
        "surfaceVariant": data.colorScheme.surfaceContainerHighest.value,
    ...
    return ThemeStruct(
        ...
        themeData: FlexColorScheme(
          ...
          colorScheme: ColorScheme(
            ...
            surfaceContainerHighest: Color(map["colorScheme"]["surfaceVariant"]),
  ...
  Map<String, Color> colors(bool dark, {bool returnMaterialYou = true}) {
    ...
    return {
      ...
      "background": finalData.colorScheme.surface,
      "onBackground": finalData.colorScheme.onSurface,
      "surface": finalData.colorScheme.surface,
      "onSurface": finalData.colorScheme.onSurface,
      "surfaceVariant": finalData.colorScheme.surfaceContainerHighest,
