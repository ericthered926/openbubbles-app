    ...
    if (ss.settings.monetTheming.value == Monet.harmonize && monetPalette != null) {
      light = light.copyWith(
        colorScheme: light.colorScheme.copyWith(
          ...
          surfaceContainerHighest: light.colorScheme.surfaceContainerHighest.harmonizeWith(Color(monetPalette!.neutralVariant.get(90))),
      ...
      dark = dark.copyWith(
        colorScheme: dark.colorScheme.copyWith(
          ...
          surfaceContainerHighest: dark.colorScheme.surfaceContainerHighest.harmonizeWith(Color(monetPalette!.neutralVariant.get(30))),
      ...
      light = light.copyWith(
        colorScheme: light.colorScheme.copyWith(
          ...
          surfaceContainerHighest: Color(monetPalette!.neutralVariant.get(90)),
      ...
      dark = dark.copyWith(
        colorScheme: dark.colorScheme.copyWith(
          ...
          surfaceContainerHighest: Color(monetPalette!.neutralVariant.get(30)),
  ...
  Tuple2<ThemeData, ThemeData> _applyWindowsAccent(ThemeData light, ThemeData dark) {
    ...
    light = light.copyWith(
      colorScheme: light.colorScheme.copyWith(
        ...
        surfaceContainerHighest: light.colorScheme.surfaceContainerHighest.harmonizeWith(Color(palette.neutralVariant.get(90))),
    ...
    dark = dark.copyWith(
      colorScheme: dark.colorScheme.copyWith(
        ...
        surfaceContainerHighest: dark.colorScheme.surfaceContainerHighest.harmonizeWith(Color(palette.neutralVariant.get(30))),
